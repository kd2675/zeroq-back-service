...
public class UserPreference extends CommonDateEntity {
    ...
    public static class Keys {
        ...
        public static final String ADMIN_OVERCAPACITY_LIMIT = "admin_overcapacity_limit";
        public static final String ADMIN_WARNING_BUFFER_PERCENT = "admin_warning_buffer_percent";
        public static final String ADMIN_SENSOR_RAW_DATA_RETENTION = "admin_sensor_raw_data_retention";
        public static final String ADMIN_SYSTEM_ERROR_RETENTION = "admin_system_error_retention";
        public static final String ADMIN_ALERT_HISTORY_RETENTION = "admin_alert_history_retention";
    }
}
